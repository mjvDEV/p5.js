...
// =============================================================================
  ...
  /**
   *
   * Shows the current element, using any previously set 'display' style setting.
   *
   * @method show
   * @return {Object|p5.Element}
   * @example
  ...
  p5.Element.prototype.show = function() {
    if (this._display) {
      ...
      // Element should already be visible, so simply save the display setting.
  ...
  p5.Element.prototype.hide = function() {
    // Avoid overwriting the saved _display if hide() called multiple times in a row.
